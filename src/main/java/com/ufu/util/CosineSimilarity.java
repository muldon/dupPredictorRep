...
public class CosineSimilarity {
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		System.out.println("Cosine similarity score = " + getCosineSimilarity(
				"As Julia points out Sujit here example is very useful", "As aa points out Sujit Pal example is very asgardddddd"));
